...
const variantClasses = {
  ...
  secondary: 'border-zinc-800 bg-zinc-900 text-zinc-300 hover:bg-zinc-800',
  outline: 'border-zinc-800 text-zinc-300',
  destructive: 'border-rose-900/50 bg-rose-950/40 text-rose-300',
  ...
  blue: 'border-sky-900/50 bg-sky-950/40 text-sky-300',
  vercel: 'border-zinc-700 bg-black text-white shadow-sm font-mono text-[11px]',
};
